  ...
  return (
    <div className=" ">
      <header className=" absolute top-0 left-0 text-white  w-full flex z-[999] justify-between items-center p-[1rem 5rem]">
        <h1 className={`ml-2 text-[3rem] font-light  ${location.pathname == '/setting'?'text-white':'text-black'}`}>MCODE</h1>
        <nav className="flex items-center gap-6 bg-white text-black p-2 rounded-xl font-bold font-medium">
          ...
          <NavLink to="/Product"  className={({isActive})=>isActive?'bg-black p-2 rounded-xl text-white' : 'text-black bg-white'}>
            <h1>Product</h1>
          </NavLink>
          <NavLink to="/Order" className={({isActive})=>isActive?'bg-black p-2 rounded-xl text-white' : 'text-black bg-white'}>
            <h1>Order</h1>
          </NavLink>
          <NavLink to="/setting" className={({isActive})=>isActive?'bg-black p-2 rounded-xl text-white' : 'text-black bg-white'}>
            <h1>Setting</h1>
          </NavLink>
        </nav>
        {authStatus === null ? (
          ...
          <div className="flex m-2 mr-3 gap-4">
            <div className="">
              <svg
                ...
                width="24px"
               fill={['/', '/setting'].includes(location.pathname) ? '#fff' : '#000'}
              >
